accounts = {
    ...
    swirldslabs = {
        ...
        notificationSelectors = getMergedData(getNotificationSelectors(), {
            ...
            ["teraswitch maintenance"] = function(inbox) return inbox:contain_subject("TeraSwitch Maintenance") * (inbox:contain_field("Reply-To", "support@teraswitch.com") + inbox:contain_field("X-Original-Sender", "support@teraswitch.com")) end,
            ["teraswitch incidents"] = function(inbox) return inbox:contain_subject("Teraswitch incident") * (inbox:contain_field("Reply-To", "support@teraswitch.com") + inbox:contain_field("X-Original-Sender", "support@teraswitch.com")) end,
