-- from https://github.com/megalithic/dotfiles/blob/79c262ef82723fe218cb0e057199f2e75613f06c/config/hammerspoon/console.lua
...
local darkMode = true
local fontStyle = { name = "Berkeley Mono", size = 15 }
