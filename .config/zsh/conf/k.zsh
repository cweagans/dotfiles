# Downloaded from https://raw.githubusercontent.com/supercrabtree/k/master/k.sh
# This is in conf instead of functions because it defines multiple functions and
# loads zsh modules as needed. Easier to just source the script than break it up.
# See https://github.com/supercrabtree/k for more info.
