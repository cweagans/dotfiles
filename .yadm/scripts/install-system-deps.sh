...
aur_packages="alacritty-git ddev-bin dropbox intellij-idea-ultimate-edition intellij-idea-ultimate-edition-jre kubernetes-helm kubernetes-kubectl neovim-gtk slack-desktop spotify ttf-input typora vale-bin yay-bin yadm-git zoom"
