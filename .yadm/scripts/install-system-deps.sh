...
aur_packages="ddev-bin drafter dropbox kubernetes-helm kubernetes-kubectl neovim-gtk slack-desktop snowboard spotify ttf-input typora vale-bin yay-bin yadm-git zoom"
