...
aur_packages="alacritty-git ddev-bin dropbox intellij-idea-ultimate-edition intellij-idea-ultimate-edition-jre keybase-bin kubernetes-helm kubectl-bin neovim-gtk slack-desktop spotify ttf-input typora vale-bin yay-bin yadm-git zazu-bin zoom"
