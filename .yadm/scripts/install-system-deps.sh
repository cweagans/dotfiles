...
aur_packages="alacritty-git ddev-bin dropbox kubernetes-helm kubernetes-kubectl neovim-gtk slack-desktop spotify ttf-input typora vale-bin yay-bin yadm-git zoom"
